...
Operational modes reference for Claude Code.
...
Meta-cognitive analysis and troubleshooting system.
...
6. **Framework Discussions**: Meta-conversations
...
- **Purpose**: Validating actions against standards
...
- **Integration**: Seamless compliance